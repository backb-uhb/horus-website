...
export const metadata: Metadata = {
  alternates: {
    canonical: "/courses/technical",
  },
};

// const getTechnicalPage = async (): Promise<THomeData> => {
//   return await frontendApi.getTechnicalTestimonials();
// };
const page = async () => {
  // const response = await getTechnicalPage();
