...
const FourthSection = () => {
  return (
    <div className="flex bg-black flex-col items-center relative ~pb-[3rem]/[14.25rem] ~px-[0.625rem]/[15.75rem] ">
      ...
      <div className="font-merriweather text-[#FFFFFF] relative z-[500] ~px-[0]/[0.75rem] font-normal ~text-[1.375rem]/[3.5rem] leading-[120%] tracking-[-0.07rem] text-center ~pt-[0.625rem]/[1.5rem]">
        ...
        <div className="bg-gradient-to-br from-[#333333] to-[#111111] w-full ">
          ...
          <div className="bg-gradient-to-t ~px-[0.75rem]/[2.5rem] from-[#171717] to-[#101010] ~rounded-[1.4119rem]/[3rem] ~py-[1rem]/[2.5rem]">
            <p className="text-white font-satoshi ~text-[0.75rem]/[1.5rem] leading-[120%]">
              Get unlimited access for 3 months to 60+ in-depth videos covering
              technicals, fundamentals, and trading psychology. Experience
              real-time market learning through exclusive live floor sessions
              (pre-booking required), and network with senior traders.
            </p>{" "}
