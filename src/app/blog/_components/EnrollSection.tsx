...
const EnrollSection = () => {
  return (
    <div className="~py-[1rem]/[7.625rem] ~px-[1.3125rem]/[14.375rem] max-w-[1440px] mx-auto">

      <div className="bg-gradient-to-r from-[#613D09] to-[#DFAB60] max-lg:overflow-hidden  rounded-[1.25rem] w-full relative lg:~min-h-[20.625rem]/[10.125rem] flex lg:flex-row flex-col items-center justify-center">
        ...
        <div className="lg:~pl-[10rem]/[16.125rem] lg:~w-full px-[0.5rem] flex xl:flex-row  flex-col max-lg:pt-[1.875rem] xl:items-center max-lg:items-center ">
