...
const VideoSection = () => {
  return (
    <div className="bg-black relative z-50 ">
      <div className="~pt-[3.4375rem]/[6.5625rem] bg-black max-w-[1440px] mx-auto ~px-[0.75rem]/[7rem] ">
        <div className="">
          <div className="items-center flex flex-col ">
            ...
            <div className="font-satoshi md:font-bold font-normal ~text-[0.75rem]/[1.25rem] \] leading-[110%] tracking-[0%] text-center text-[#FFF4E3] ">
              ...
              <br /> Horus isn’t just teaching trades, it’s building the next{" "}
              <br /> generation of professionals.
            </div>
          </div>
