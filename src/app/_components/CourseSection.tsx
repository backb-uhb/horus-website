...
const CourseSection = () => {
  return (
    <div className="~px-[0.75rem]/[6.25rem] relative  ~pt-[2.6875rem]/[9.0625rem]">
      ...
      <div className="~pt-[1.875rem]/[4.5rem] space-y-8">
        {courses.map((course, index) => (
          <div
            key={index}
            className={`sticky ${index === 0 ? "top-[5rem]" : " top-[8rem]"}`}
          >
              ...
              <div className="relative w-full bg-gradient-to-b from-[#101010]   ~pb-[0.7344rem]  ~rounded-[0.75rem]/[3rem] flex flex-col">
                <div className="~pl-[0.9219rem]/[2.625rem] md:pt-[2.625rem] ~pb-[1rem]/[2.625rem] ">
                  ...
                  <div className=" relative z-10 ">
                    ...
                    <ButtonAnimation>
                      <Link href={"/about-us"} className="relative p-[1px]  rounded-full bg-gradient-to-l from-[#F3C070] to-[#3B2A16] w-fit">
                        <div className="flex items-center ~gap-[0.35rem]/[0.62rem] ~rounded-[0.9938rem]/[4.125rem] cursor-pointer transition-all duration-300 ease-in-out ~py-[0.375rem]/[0.5rem] ~px-[0.375rem]/[1rem] bg-[#111] hover:bg-transparent">
