...
const FounderSection = () => {
  return (
    <div className="bg-black ~px-[0.75rem]/[7.4375rem]">
      <div className="">
        <ButtonBrown content="Founder Talks" />
        <div className="flex md:flex-row items-center gap-[1.5rem] md:~gap-[-5rem]/[7rem] flex-col-reverse pt-[1.875rem] ~pb-[3rem]/[10.6875rem] justify-between">
          <div className="md:w-[60%]">
            ...
            <div className="font-satoshi font-normal ~space-y-[1rem]/[2rem] md:~pr-[0]/[4rem] ~text-[0.75rem]/[1.5rem] text-[#FFF4E3] ~pt-[1rem]/[1.875rem] leading-[130%] ~tracking-[-0.00375rem]/[-0.015rem] ">
              ...
              <div>
               The Horus Academy was created to change that. Driven by
