...
const Breadcrumbs = ({ activepage, innerpage, activePageLink }: Props) => {
  return (
    <div className="font-satoshi font-medium items-center relative z-[50] ~text-[0.625rem]/[0.875rem] leading-[105%] tracking-[0%] flex gap-[0.5rem] ~pt-[5rem]/[8.7rem] ~pl-[0.625rem]/[7rem]">
      <Link href={"/"}>
